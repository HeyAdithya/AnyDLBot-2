    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Son, You are Banned to use me. Contact my [Support Group](https://t.me/BharatCoding).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🤖 Join Updates Channel", url="https://t.me/BharatCoding")
                    ]
                ]
            ),
            parse_mode="markdown"
